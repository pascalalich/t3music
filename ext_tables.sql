#
# Table structure for table 'tx_t3music_domain_model_album'
#
CREATE TABLE tx_t3music_domain_model_album (
...
#
# Table structure for table 'tx_t3music_domain_model_track'
#
CREATE TABLE tx_t3music_domain_model_track (
